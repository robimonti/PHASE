...
outlog = logfolder + '/SEN_tc_proc_stdout.log'

COH_FLAG = int(TC_COHERENCE)

if COH_FLAG == 0:
    graphxml = GRAPH + '/SEN_slave_terrain_correction.xml'
    print(graphxml)
    graph2run = PROJECT + '/graphs/SEN_terrain_correction2run.xml'
    ...
    with open(outlog, 'a') as out_file:
        ...
        for dimfile in interferogram_files:
            ...
            sourceband_lia = 'localIncidenceAngle_' + POLARISATION
