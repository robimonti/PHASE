...
graph2run=PROJECT+'/graphs/CSK_subsetMgraph2run.xml'
outlog=logfolder+'/CSK_subsetM_proc_stdout.log'
...
for acdatefolder in sorted(os.listdir(masterfolder)):
    ...
    files = glob.glob(os.path.join(masterfolder, acdatefolder) + '/*.h5')
    print(files)
    ...
    filedata = filedata.replace('OUTPUTFILE',subsetfolder+'/'+outputname)
