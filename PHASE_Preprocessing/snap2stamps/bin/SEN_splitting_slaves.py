...
message='## TOPSAR Splitting and Apply Orbit (Slaves)\n'
print(message)
...
for acdatefolder in sorted(os.listdir(slavefolder)):
    ...
    head, tail = os.path.split(str(files[0]))
    ...
    for swath in swaths:
        outputname = f"{tail[17:25]}_{swath}.dim"
        ...
        if process.returncode != 0:
            ...
            msg = f"  -> Success: Split slave {swath} completed in {timeDelta:.2f}s.\n"
            print(msg)
            out_file.write(msg)
