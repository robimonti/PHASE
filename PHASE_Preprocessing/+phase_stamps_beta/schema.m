...
items(end+1) = item('master_date', 'Master date', 'project', 'date', 'YYYYMMDD', ...
    'Reference acquisition date. Uses the native calendar when metadata detection is unavailable.', {}, false);
...
items(end+1) = item('train_enabled', 'TRAIN tropospheric correction', 'step1', 'toggle', '', ...
...
items(end+1) = item('density_rand', 'Random density', 'step3', 'number', 'PS/km²', ...
