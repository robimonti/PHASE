function [coeffs, model_func] = fit_gaussian_auto(lags, cov_vals, variances)

% fit_gaussian_auto Fits a Gaussian model using polynomial smoothing and outlier removal
%
% Inputs:
...
if length(tauGrid) < 4
    ...
    model_func = @(c, tau) c(1) .* exp(-c(2) .* tau.^2);
